...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        behavior.setText("Перетаскивайте помощника пальцем — после отпускания он привязывается к ближайшему краю. Двойное касание сворачивает или разворачивает его. Долгое нажатие вызывает заметную, но мягкую реакцию внимания; если русские голосовые реакции включены, помощник отвечает короткой фразой через локальный Android TTS. Обычное касание переводит взгляд к точке касания. Размер, сторона, положение и состояние сохраняются, а Fold-переход пересчитывается по безопасной области дисплея.");
        ...
        privacy.setText("Приватность: для плавающего окна требуется только системное разрешение «Поверх других приложений». Камера, микрофон, точная геолокация и передача исходных медиа не используются. Долгое нажатие не включает распознавание речи: ответ формируется локально из состояния AI, а анимация лица и русская TTS-мимика вычисляются на устройстве.");
