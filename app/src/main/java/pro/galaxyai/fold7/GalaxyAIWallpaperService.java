...
public class GalaxyAIWallpaperService extends WallpaperService {
    ...
    public Engine onCreateEngine() {
        ...
        return new V19Engine(identity.seed, identity.evolutionEpoch);
    }
    ...
    private class V19Engine extends Engine {
        ...
        private final EventHorizonUniverseControllerV19 universe;
        private boolean visible;
        private long frameDelayMillis = 37L;

        V19Engine(long universeSeed, long evolutionEpoch) {
            universe = new EventHorizonUniverseControllerV19(universeSeed, evolutionEpoch);
        }
